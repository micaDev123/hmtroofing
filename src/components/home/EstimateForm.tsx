          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label htmlFor="fullName" className="block text-sm font-medium text-gray-700 mb-2">
                  {t('estimateForm.fullName')} {t('estimateForm.required')}
                </label>
                <input
                  type="text"
                  id="fullName"
                  ...
                  placeholder={t('estimateForm.placeholders.fullName')}
                />
              </div>
              ...
              <div>
                <label htmlFor="phoneNumber" className="block text-sm font-medium text-gray-700 mb-2">
                  {t('estimateForm.phoneNumber')} {t('estimateForm.required')}
                </label>
                <input
                  type="tel"
                  id="phoneNumber"
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-green focus:border-transparent outline-none transition-colors"
                  placeholder={t('estimateForm.placeholders.phoneNumber')}
                />
              </div>
            </div>
            ...
            <div>
              <label htmlFor="propertyAddress" className="block text-sm font-medium text-gray-700 mb-2">
                {t('estimateForm.propertyAddress')} {t('estimateForm.required')}
              </label>
              <input
                type="text"
                id="propertyAddress"
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-green focus:border-transparent outline-none transition-colors"
                placeholder={t('estimateForm.placeholders.propertyAddress')}
              />
            </div>
            ...
            <div>
              ...
              >
                {roofingTypes.map((type, index) => (
                  <option key={index} value={index === 0 ? '' : t(type)}>
                    {t(type)}
                  </option>
                ))}
              </select>
